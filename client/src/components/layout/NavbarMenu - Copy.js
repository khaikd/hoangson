        ...
        <Fragment>
            ...
            <Navbar expand='lg' bg='primary' variant='dark' className='shadow'>
                <Navbar.Brand className='font-weight-bolder text-white'>
                    <img src={learnItLogo} alt="Learn It" width='32' height='32' className='mr-2' />
                    LearnIt
                </Navbar.Brand>
                ...
                <Navbar.Collapse id='basic-navbar-nav'>
                    ...
                    <Nav>
                        <Nav.Link className='font-weight-bolder text-white' disabled>Wellcome {username}</Nav.Link>
                        <Button variant='secondary' className='font-weight-bolder text-white' onClick={logout}>
                            <img src={logoutIcon} alt="Logout Learn It" width='32' height='32' className='mr-2' />
                            Logout
                        </Button>
                    </Nav>
                </Navbar.Collapse>
