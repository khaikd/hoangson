        ...
        <Modal show={showUpdatePostModal} onHide={closeDialog}>
            ...
            <Form onSubmit={onSubmit}>
                <Modal.Body>
                    ...
                    <Form.Group>
                        <Form.Control as='textarea' row={3} placeholder='Description' name='description' value={description} onChange={onChangeUpdatedPostForm} />
                    </Form.Group>
                    <Form.Group>
                ...
                <Modal.Footer>
                    ...
                    <Button variant='primary' type='submit'>Update LearnIt!</Button>
                </Modal.Footer>
            </Form>
        </Modal>
    )
